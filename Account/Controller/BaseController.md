...
Le compte actuel est ajouté à la collection **HttpContext.Items** par le **custom jwt middleware** lorsque la demande contient un jeton JWT valide dans l'en-tête d'autorisation.