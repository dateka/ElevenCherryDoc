...
Dans cet exemple, un jeton d'actualisation appartient toujours à **[account entity](https://github.com/dateka/ElevenCherryDoc/blob/main/Account/Entities/AccountEntity.md)**.
