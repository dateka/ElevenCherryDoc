...
Par exemple, le **account service** accède aux paramètres de l'application via un objet **IOptions<AppSettings> appSettings** qui est injecté dans le constructeur.
