...
Consultez le **account service** pour des exemples d'exceptions d'application qui sont levées. Découvrez où les différents types d'exceptions sont gérés dans le **error handler middleware**.